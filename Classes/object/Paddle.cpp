...
#include "FilePath.h"
using namespace std;
Paddle::Paddle(void): m_playerSprite(NULL)/*,m_enableSit(false)*//*,m_haveTarget(false)*//*,m_chairType(-1)*/
{
// 	m_chairPartSprite[0] = NULL;
// 	m_chairPartSprite[1] = NULL;
}
...
// 	case 1:
// 		{
// 			m_playerSprite = CCSprite::create(g_man_1_part);
// 			m_playerSprite->setAnchorPoint(CCPoint());
// 			m_playerSprite->setPosition(CCPoint(-8,-15));
// 			this->addChild(m_playerSprite, 100);
...
// 	case 2:
// 		{
// 			m_playerSprite = CCSprite::create(g_man_2_part);
// 			m_playerSprite->setAnchorPoint(CCPoint());
// 			m_playerSprite->setPosition(CCPoint(-25,25));
// 			this->addChild(m_playerSprite, 100);
// 
// 			m_chairPartSprite[0]= CCSprite::create(g_chair_1_part);
// 			m_chairPartSprite[0]->setAnchorPoint(CCPoint());
// 			m_chairPartSprite[0]->setPosition(CCPoint(0,-15));
// 			this->addChild(m_chairPartSprite[0], 101);
// 
// 			m_chairPartSprite[1]= CCSprite::create(g_chair_2_part);
// 			m_chairPartSprite[1]->setScaleX(-1);
// 			m_chairPartSprite[1]->setAnchorPoint(CCPoint());
// 			m_chairPartSprite[1]->setPosition(CCPoint(0,-15));
// 			this->addChild(m_chairPartSprite[1], 101);
...
// 		m_playerSprite = NULL;
// 	}
// 	if (m_chairPartSprite[0])
// 	{
// 		m_chairPartSprite[0]->removeFromParentAndCleanup(true);
// 		m_chairPartSprite[0] = NULL;
// 	}
// 	if (m_chairPartSprite[1])
// 	{
// 		m_chairPartSprite[1]->removeFromParentAndCleanup(true);
// 		m_chairPartSprite[1] = NULL;
// 	}
// }
